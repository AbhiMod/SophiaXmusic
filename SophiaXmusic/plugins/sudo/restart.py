...
from SophiaXmusic.misc import HAPP, SUDOERS, XCB
from SophiaXmusic.utils.database import (
    get_active_chats,
    remove_active_chat,
    remove_active_video_chat,
)
from SophiaXmusic.utils.decorators.language import language
...
async def restart_(_, message):
    ...
    os.system(f"kill -9 {os.getpid()} && cd && rm -rf SophiaXmusic && git clone https://github.com/AbhiMod/SophiaXmusic && cd SophiaXmusic && bash start")
